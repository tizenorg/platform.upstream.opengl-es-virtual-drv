...
ln -sf %{_libdir}/libEGL.so.1.5 %{buildroot}%{_libdir}/libEGL.so
ln -sf %{_libdir}/libEGL.so.1.5 %{buildroot}%{_libdir}/libEGL.so.1
ln -sf %{_libdir}/libGLESv1.so.1.1 %{buildroot}%{_libdir}/libGLESv1.so
ln -sf %{_libdir}/libGLESv1.so.1.1 %{buildroot}%{_libdir}/libGLESv1.so.1
ln -sf %{_libdir}/libGLESv1.so.1.1 %{buildroot}%{_libdir}/libGLESv1_CM.so
ln -sf %{_libdir}/libGLESv1.so.1.1 %{buildroot}%{_libdir}/libGLESv1_CM.so.1
ln -sf %{_libdir}/libGLESv1.so.1.1 %{buildroot}%{_libdir}/libGLESv1_CM.so.1.1
ln -sf %{_libdir}/libGLESv2.so.2.0 %{buildroot}%{_libdir}/libGLESv2.so
ln -sf %{_libdir}/libGLESv2.so.2.0 %{buildroot}%{_libdir}/libGLESv2.so.2
ln -sf %{_libdir}/libGLESv3.so.3.1 %{buildroot}%{_libdir}/libGLESv3.so
ln -sf %{_libdir}/libGLESv3.so.3.1 %{buildroot}%{_libdir}/libGLESv3.so.3
...
%{_libdir}/libGLESv1.so
%{_libdir}/libGLESv1.so.1
%{_libdir}/libGLESv1.so.1.1
